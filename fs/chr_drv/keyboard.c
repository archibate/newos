...
static int kbrd_init();
static void x86_kbr_irq_do_handle();
...
int kbd_getc(int *pc)
{
	...
	if (!kbd_dat)
		return 0;
	for (; kbd_dat && !(c = kbd_dat >> 24); kbd_dat <<= 8);
	kbd_dat <<= 8;
	*pc = c;
	return 1;
}
...
{
	if (kbrd_init() == -1)
		panic("kbrd_init failed");
	install_irq(IRQ_KBD, kbd_intr);
	irq_enable(IRQ_KBD, 1);
}

void shell_kbrd_cb(int c)
{
	kbd_dat = c;
}

#define irq_done(...) /* Nothing */
#define ISDIGIT isdigit
#define ISSYMBOL ispunct
#define ISALPHA isalpha
#define ISLOWER islower
#define TOUPPER toupper
#define ISPRINTABLE isascii
#define true 1
#define false 0
#define bool int
#define inportb inb
...
#define KEY_F6                 0x1b5b5b46
#define KEY_F7                 0x1b5b5b47
#define KEY_F8                 0x1b5b5b48
#define KEY_F9                 0x1b5b5b49
#define KEY_F10                0x1b5b5b50
#define KEY_F11                0x1b5b5b51
#define KEY_F12                0x1b5b5b52
#define KEY_F13                0x1b5b5b53
#define KEY_F14                0x1b5b5b54
#define KEY_F15                0x1b5b5b55
...
#define KEY_KP_NUMLOCK         0x1b1b400f
#define KEY_KP_ENTER           '\n'

#define KEY_TAB                '\t'
#define KEY_CAPSLOCK           0x1b1b4001

/*
 * Modify Keys
 */

#define KEY_LSHIFT             0x1b1b4002
#define KEY_LCTRL              0x1b1b4003
#define KEY_LALT               0x1b1b4004
#define KEY_LWIN               0x1b1b4005
#define KEY_RSHIFT             0x1b1b4006
#define KEY_RCTRL              0x1b1b4007
#define KEY_RALT               0x1b1b4008
#define KEY_RWIN               0x1b1b4009
 ...
 */
static const int SCAN_CODES_SINGLE[] = {
	[0x1]   = KEY_ESCAPE,
	[0x2]   = KEY_1,
	[0x3]   = KEY_2,
	[0x4]   = KEY_3,
...
static const int SCAN_CODES_MULTI[] = {
	[0x1C]  = KEY_KP_ENTER,
	[0x1D]  = KEY_RCTRL,
	[0x35]  = KEY_KP_DIVIDE,
	[0x37]  = KEY_PRINT,
...
static const int SCAN_CODES_BREAK[] = {
	[0xAA]  = KEY_LSHIFT,
	[0xB6]  = KEY_RSHIFT,
	[0xBA]  = KEY_CAPSLOCK,
	[0x9D]  = KEY_LCTRL
...
static const int SCAN_CODES_SYMBOLS[] = {
	[0x2]   = KEY_EXCLAMATION,
	[0x3]   = KEY_AT,
	[0x4]   = KEY_HASH,
	[0x5]   = KEY_DOLLAR,
...
static int shift_effect(int c, short code)
{
